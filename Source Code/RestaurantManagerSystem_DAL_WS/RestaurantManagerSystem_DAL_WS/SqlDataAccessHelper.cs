...
namespace DAO
{
    ...
    {
        //Chuỗi kết nối
        private static String _connectionString = @"Data Source=.\sqlexpress;Initial Catalog=ResManager;Integrated Security=True";
        //ExecuteQuery : Select
        ...
        public static bool CheckConnect(String sql)
        {
            DataTable dt = new DataTable();
            SqlConnection connect = new SqlConnection(_connectionString);
            try
